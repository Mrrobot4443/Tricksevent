<!DOCTYPE html><html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset('admin-dash/css/vendors/flatpickr.min.css') }}" rel="stylesheet">
        <link href="{{asset ('admin-dash/css/vendors/style.css') }}" rel="stylesheet">
    </head>
    ...
    <body class="gs bs hi g_" :class="{ 'sidebar-expanded': sidebarExpanded }" x-data="{ sidebarOpen: false, sidebarExpanded: localStorage.getItem('sidebar-expanded') == 'true' }" x-init="$watch('sidebarExpanded', value => localStorage.setItem('sidebar-expanded', value))">
        ...
        <script src="{{ ('admin-dash/js/vendors/alpinejs.min.js') }}" defer=""></script>
        <script src="{{ ('admin-dash/js/vendors/chart.js') }}"></script>
        <script src="{{ ('admin-dash/js/vendors/moment.js') }}"></script>
        <script src="{{ ('admin-dash/js/vendors/chartjs-adapter-moment.js') }}"></script>
        <script src="{{ ('admin-dash/js/dashboard-charts.js') }}"></script>
        <script src="{{ ('admin-dash/js/vendors/flatpickr.js') }}"></script>
        <script src="{{ ('admin-dash/js/flatpickr-init.js') }}"></script>
