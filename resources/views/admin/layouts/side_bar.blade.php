...
<div class="quixnav">
    <div class="quixnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="mdi mdi-airballoon"></i><span class="nav-text">Villes</span></a>
                <ul aria-expanded="false">
                    <li><a href="{{ route('ville.create') }}">Ajouter une ville</a></li>
                    <li><a href="{{ route('ville.index') }}">Listes des villes</a></li>
                </ul>
            </li>
            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="mdi mdi-map"></i><span class="nav-text">events</span></a>
                <ul aria-expanded="false">
