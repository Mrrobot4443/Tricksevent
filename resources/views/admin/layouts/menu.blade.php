 ...
 <div class="left-sidenav">
    ...
    <div class="menu-content h-100" data-simplebar>
        <ul class="metismenu left-sidenav-menu">
            ...
            <li>
                <a href="{{ route('category.index') }}"><i data-feather="grid" class="align-self-center menu-icon"></i><span>Category</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
